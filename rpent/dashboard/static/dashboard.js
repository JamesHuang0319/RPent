...
const COPY = {
  en: {
    ...
    checkStatuses: {
      ...
      invalid_model: "the provider rejected the model id",
      image_rejected: "the endpoint refused image input",
      tool_calls_unsupported: "the model did not call the offered tool",
  ...
  "zh-cn": {
    ...
    checkStatuses: {
      ...
      invalid_model: "provider 不接受该模型 id",
      image_rejected: "该端点不接受图像输入",
      tool_calls_unsupported: "模型未调用提供的工具",
